...
{
    internal class GrassBackground : DrawableGameComponent
    {
        ...
        internal GrassBackground(Game game, SpriteBatch spriteBatch, Texture2D texture, Rectangle rectangle, Vector2 position, Vector2 velocity) : base(game)
        {
            this.spriteBatch = spriteBatch;
            this.texture = texture;
            this.rectangle = rectangle;
            position1 = position;
            position2 = new Vector2(position1.X, position1.Y + rectangle.Height);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            position1 += changedVelocity;
            position2 += changedVelocity;
